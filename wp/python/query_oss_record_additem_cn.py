...
# 返回数据为: itemid,src,uid,cid,sum(itemnum)
...
if __name__ == '__main__':
    ...
    itemids = (12001610,12001620,12001630,12001640,12001650,12001660,12001670,
               12001680,12001690,12001700,12001710,12001720,12001530,12001540,
               12001730,12001740,12001750,12001760,12001550,12001760)
    logging.info('功能未完成')
    exit()
