...
# revision on 2024-03-06
##################################
##脚本功能：
# 备份docker启动的mysql database，备份文件存储到minio
#+ 在minio中的存储路径，多了容器筛选的关键词，用于区别一台虚拟机多个mysql实例的情况
#
##脚本说明：
#+ 增加备份故障邮件报警
##特别说明：
...
MINIO_STORAGE_BUCKETS_PATH="bfsh-minio/iamUserName-bak/${TEMP_IPADDR}/mysql_daily_bak/${CONTAINER_GREP_KEY}/"
#+ 登录harbor
